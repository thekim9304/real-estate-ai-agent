# 부동산 QA AI 에이전트 (Real Estate QA AI Agent)

사용자의 자연어 질문에 담긴 의도를 파악하고, 공공 데이터 및 지도 API를 활용하여 부동산 관련 정보를 분석하고 생성형 AI를 통해 답변하는 프로젝트
...
| [ ] | **2. AI Agent 티키타카(대화) 기능 개발** |
| [ ] | 2-1. 대화 기록(History) 관리 및 컨텍스트 유지 |
| [ ] | 2-2. 후속 질문(Follow-up Question) 이해 및 처리 (e.g., "그럼 거긴 어때?") |
| [ ] | 2-3. 불완전한 질의에 대한 되묻기(Clarification) 기능 (e.g., "매매를 찾으시나요, 전세를 찾으시나요?") |
| [ ] | 2-4. 이전 답변 참조 및 비교/요약 기능 |
| [ ] | **3. Web Page 개발** (Streamlit / Flask 기반) |
| [ ] | **4. Backend 개발** |
| [ ] | 4-1. DB (사용자 및 대화 내용 저장) |
| [ ] | 4-2. Session / State 관리 |
